...
cleanup_stale_processes() {
  ...
  safe_kill_by_pattern "turtlebot3_world.launch.py"
  safe_kill_by_pattern "cartographer.launch.py"
  safe_kill_by_pattern "ros2 run dstar_planner ros2_dstar_node"
  safe_kill_by_pattern "python3 .*ros2_dstar_node.py"
